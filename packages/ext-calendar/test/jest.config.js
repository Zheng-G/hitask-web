...
const usedTranslationKeysHash = require(paths.locales('dist/ext-calendar-used-keys.json')); // eslint-disable-line import/no-dynamic-require
...
const jestConfig = {
	...
	testMatch: [
		...
		'<rootDir>/packages/ext-calendar/test/**/?(*.)test.js',
	],
	globals: {
